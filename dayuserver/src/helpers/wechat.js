    ...
    constructor() {
        var opts = {
            ...
            getAccessToken: function () {
                let data = fileHelper.readFileAsync(wechat_file, 'utf-8')
                ...
                this.expires_in = data
                    .expires_in
                    this
                    .saveAccessToken(JSON.stringify(data))
    ...
    updateAccessToken() {
        return new Promise(async (resolve, reject) => {
            ...
            var appSecret = this
                ...
                console
                .log(
                    'wechat ' + WxApi.accessToken + "&appid=" + appId + "&secret=" + appSecret
                )
            var res = await koa2Req(
                WxApi.accessToken + "&appid=" + appId + "&secret=" + appSecret
            )

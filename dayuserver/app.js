...
const menu = require('./src/routes/api/menu')
const review = require('./src/routes/api/review')

const meterail = require('./src/routes/api/meterail')
...
app.use(review.routes(), review.allowedMethods())
app.use(meterail.routes(),meterail.allowedMethods())
